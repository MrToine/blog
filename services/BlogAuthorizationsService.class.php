<?php
/*##################################################
 *		                BlogAuthorizationsService.class.php
 *                            -------------------
...
class BlogAuthorizationsService
{
	...
	{
		return AppContext::get_current_user()->check_auth(BlogConfig::load()->get_authorizations(), $bit);
	}
}
?>
