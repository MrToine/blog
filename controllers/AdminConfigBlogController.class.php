...
class AdminConfigBlogController extends AdminModuleController {
	...
	private function build_form_config(){
		...
		$fieldset->add_field(new FormFieldNumberEditor('number_blogs_per_user', $this->lang['config.form.nb_blogs_per_user'], $this->config->get_nb_blogs_per_user(), array(
	...
	private function build_form_style(){
		...
		$form->add_fieldset($fieldset);
		$fieldset->add_field(new FormFieldSimpleSelectChoice('bloc_or_list', $this->lang['config.form.bloc_or_list'], $this->config->get_display_blogs(),
		array(
